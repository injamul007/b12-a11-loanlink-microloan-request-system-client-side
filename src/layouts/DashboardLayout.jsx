            ...
            <div className="absolute left-0 top-0 bottom-0 w-72 bg-[#071422] p-4 overflow-auto text-white">
              <div className="flex items-center justify-between mb-4">
                <Link to="/" className="flex items-center gap-3" onClick={() => setOpen(false)}>
                  <span className="font-extrabold text-[#4DA3FF] flex items-center"><img src={dashboardLogo} alt="dashboardLogo" className="lg:w-10 w-8" /> Micro<span className="text-[#FFB703]">Loan</span></span>
                </Link>
