    ...
    <div>
      <MyContainer className='lg:pt-34 pt-14 lg:pb-6 px-6'>
        <div className="text-center mb-12">
          ...
          <p className="mt-6 text-md text-gray-500 font-semibold max-w-2xl mx-auto">Explore our top {availableLoans.length} microloans</p>
        </div>

        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-6">
          {
            availableLoans.map(loan => <LoanCard key={loan._id} loan={loan}></LoanCard>)
          }
        </div>
      </MyContainer>
    </div>
