...
const AddLoan = () => {
  ...
  return (
    <div className="w-full min-h-[calc(100vh-40px)] flex flex-col justify-center items-center text-gray-800 rounded-xl">
      <title>Microloan || Add Loan</title>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
          <div className="space-y-6">
            ...
            <div className="space-y-1 text-sm">
              ...
              <input
                ...
                {...register("loan_title", {
                  required: { value: true, message: "Loan title is Required" },
                  maxLength: {
                    value: 30,
          ...
          <div className="space-y-6 flex flex-col">
            ...
            <div className="flex justify-between gap-2">
              {/* Interest Rate */}
              <div className="space-y-1 text-sm">
                <label htmlFor="interest_rate" className="block text-gray-600 ">
                  Interest Rate
                </label>
                <input
                  className="w-full px-4 py-3 rounded-md text-gray-800 border border-blue-300 focus:outline-blue-600  bg-white dark:bg-[#2b3138] dark:text-white"
              ...
              {/* Max Loan Limit */}
              <div className="space-y-1 text-sm">
                <label htmlFor="max_loan_limit" className="block text-gray-600">
                  Max Loan Limit
                </label>
                <input
                  className="w-full px-4 py-3 rounded-md text-gray-800 border border-blue-300 focus:outline-blue-600  bg-white dark:bg-[#2b3138] dark:text-white"
